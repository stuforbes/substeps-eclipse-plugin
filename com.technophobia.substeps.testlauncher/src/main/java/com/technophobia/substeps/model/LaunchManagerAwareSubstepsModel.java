...
public class LaunchManagerAwareSubstepsModel implements SubstepsModel {
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#start()
     */
    @Override
    public void start() {
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#stop()
     */
    @Override
    public void stop() {
        final ILaunchManager launchManager = DebugPlugin.getDefault().getLaunchManager();
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#addTestRunSessionListener(com.technophobia.substeps.junit.ui.SubstepsRunSessionListener)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#removeTestRunSessionListener(com.technophobia.substeps.junit.ui.SubstepsRunSessionListener)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#getTestRunSessions()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#addTestRunSession(com.technophobia.substeps.junit.ui.SubstepsRunSession)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#removeTestRunSession(com.technophobia.substeps.junit.ui.SubstepsRunSession)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.technophobia.substeps.model.SubstepsModel#getTestRunListeners()
     */
    @Override
